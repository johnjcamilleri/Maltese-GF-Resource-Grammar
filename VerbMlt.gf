...
concrete VerbMlt of Verb = CatMlt ** open Prelude, ResMlt in {
  ...
  lin
    ...
    PassV2 v2 = case v2.hasPastPart of {
      True  => insertObj (\\agr => stem1 (v2.s ! VPastPart (toGenNum agr)) ++ v2.c2.s ! Definite) CopulaVP ;
      False => insertObj (\\agr => stem1 (v2.s ! VPerf (toVAgr agr)) ++ v2.c2.s ! Definite) CopulaVP
      } ;
