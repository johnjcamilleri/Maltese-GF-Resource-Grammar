...
concrete StructuralMlt of Structural = CatMlt **
  ...
  lin
    ...
    he_Pron = mkPron "huwa" "tiegħu" singular P3 masculine ;
    -- here_Adv = mkAdv "here" ;
    ...
    i_Pron  = mkPron "jien" "tiegħi" singular P1 ;
    -- in_Prep = mkPrep "in" ;
    ...
    she_Pron = mkPron "hija" "tagħha" singular P3 feminine ;
    -- so_AdA = mkAdA "so" ;
    ...
    -- yes_Utt = ss "yes" ;
    youSg_Pron = mkPron "inti" "tiegħek" singular P2 ;
    youPl_Pron = mkPron "intom" "tagħkom" plural P2 ;
